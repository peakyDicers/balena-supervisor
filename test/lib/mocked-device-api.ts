...
const originalSvcGetStatus = serviceManager.getLegacyState;
...
function setupStubs() {
	...
	// @ts-expect-error Assigning to a RO property
	serviceManager.getLegacyState = async () => STUBBED_VALUES.services;
	// @ts-expect-error Assigning to a RO property
...
function restoreStubs() {
	...
	// @ts-expect-error Assigning to a RO property
	serviceManager.getLegacyState = originalSvcGetStatus;
	// @ts-expect-error Assigning to a RO property
